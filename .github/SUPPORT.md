# Getting help with ggnormalviolin

Thanks for using ggnormalviolin. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ggnormalviolin/issues) to make sure the 
